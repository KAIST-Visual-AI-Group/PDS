...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help=("If True, do not crop an image"),
    )
    ####
    parser.add_argument(
        "--center_crop",
...
if __name__ == "__main__":
    args = parse_args()
    dic_of_args = vars(args)
    save_config(args.output_dir, dic_of_args)
    main(args)
